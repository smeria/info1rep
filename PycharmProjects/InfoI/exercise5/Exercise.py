...
def v_or_h():
    ...
    while (True):
        ...
        if user_input == "v" or user_input == "h":
            ...
            print
            "Invalid input. Please only enter v or h"
...
def get_coor():
    while (True):
        ...
        try:
            ...
            print
            "Invalid entry. Please enter only numeric values for coordinates"
...
def user_move(board):
    ...
    while (True):
        ...
        if res == "hit":
            ...
            print
            "Sorry, " + str(x + 1) + "," + str(y + 1) + " is a miss."
            board[x][y] = "*"
        elif res == "try again":
            print
            "Sorry, that coordinate was already hit. Please try again"
