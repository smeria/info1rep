...
def place_ship(board, coordinates):
    ...
    """
    if are_valid_ship_coordinates(board, coordinates) == True and are_coordinates_valid(board,coordinates) == True:
...
def fire(board, coordinates):
    ...
    """
    valid = are_coordinates_valid(board, coordinates)
    if valid:
...
def is_game_over(board):
    ...
    # for row in board:
    #     for value in row:
    #         if value == SHIP: # If any cell contains a floating ship, the game is not over
    #             return False
    #         else:
    #             return True
